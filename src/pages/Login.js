...
const Login = () => {
  ...
  if (hasAccount) {
    url =
      'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCB2P8_r8feLXVmRMO7eZRtr0ULvAftckQ';
  } else {
    url =
      'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCB2P8_r8feLXVmRMO7eZRtr0ULvAftckQ';
  }
